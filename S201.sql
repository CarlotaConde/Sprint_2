...
SELECT 
    ...
    AVG(transaction.amount) as 'Mitijana de vendes'
FROM 
    company
JOIN 
    transaction 
...
SELECT 
    ...
    AVG(transaction.amount) AS 'Mitja de ventes'
FROM 
	transaction
JOIN 
	company
...
HAVING
	timestamp like '2021-04-29%'
    OR timestamp like '2021-07-20%'
    OR timestamp like '2022-03-13%' 
ORDER BY 
